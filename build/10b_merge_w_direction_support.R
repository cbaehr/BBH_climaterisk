...
support_bills <- bill[which(bill$label_name=="Support") , ]
...
save(lobbying_firmquarter, file="data/02_processed/lobbying_df_quarterly_REVISE_NEW_altclimatebills_support.rds")
...
arrow::write_parquet(exposure_orbis_lobbyview_long, "data/03_final/lobbying_df_quarterly_REVISE_NEW_altclimatebills_support.parquet")

# ## write csv
# fwrite(exposure_orbis_lobbyview_long, "data/03_final/lobbying_df_quarterly_REVISE_NEW_altclimatebills_support.csv")
# 
# # write rdata
# write_rds(exposure_orbis_lobbyview_long, "data/03_final/lobbying_df_quarterly_REVISE_NEW_altclimatebills_support.rds")
