...
orbis1 <- readxl::read_xlsx("orbis/bbh_orbis_11_05_2023_1_6000.xlsx", sheet = 2)
orbis2 <- readxl::read_xlsx("orbis/bbh_orbis_11_05_2023_6001_12000.xlsx", sheet = 2)
orbis3 <- readxl::read_xlsx("orbis/bbh_orbis_11_05_2023_12001_12969.xlsx", sheet = 2)
...
names(orbis) <- c("row", "conm", "inactive", "quoted", "branch", "owndata", "woco",
                  ...
                  "lastavail", "nace_main_section", "nace_core_4digit_dup",
