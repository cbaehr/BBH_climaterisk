...
#Load data
df <- arrow::read_parquet("data/03_final/lobbying_df_quarterly_REVISE_NEW_altclimatebills_support.parquet")
df <- data.frame(df)
...
arrow::write_parquet(df, "data/03_final/lobbying_df_quarterly_REVISE_normal_NEW_altclimatebills_support.parquet")
# 
# # write csv
