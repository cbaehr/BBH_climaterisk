...
View(dups[, c("bvdid", "isin", "cc_expo_ew_2016",
              "gvkey", "hqcountrycode", "conm",
              "total_assets_usd_2016", "client_uuid", "client_name", "keep_override", "NAs", "NA_col")])
dupnames <- c("bvdid", "isin", "cc_expo_ew_2016",
              "gvkey", "hqcountrycode", "conm",
              "total_assets_usd_2016", "client_uuid", "client_name")
# write.csv(dups[, c(dupnames)], "xx_other/exposure_orbis_clientuuid_duplicated.csv", row.names=F)
...
write.csv(dups2, "xx_other/exposure_orbis_clientuuid_duplicated_withlobbying.csv", row.names=F)
