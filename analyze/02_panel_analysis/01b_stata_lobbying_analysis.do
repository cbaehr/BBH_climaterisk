...
global impute_annual 1
global compare_annual 1
global tobit_quarter 1
global impute_quarter 1
global compare_annual 1
...
mi register imputed ebit_z at_z ebit_at_z
...
est store m1
mi estimate, post: logit CLI_annual op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual, vce(cluster isin_n)
est store m2
mi estimate, post: logit CLI_annual op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year, vce(cluster isin_n)
est store m3
mi estimate, post: logit CLI_annual op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year i.industry_n, vce(cluster isin_n)
est store m4
mi estimate, post: logit CLI_annual op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year i.industry_n i.industry_year_n, vce(cluster isin_n)
est store m5
...
gen log_CLI_amount_quarterly = log(CLI_amount_quarterly + 1)
*gen ebit_at = ebit/at
*egen year_industry = group(year industry)
*destring year, replace
egen industry_n = group(industry)
...
su log_CLI_amount_quarterly op_expo_ew rg_expo_ew ph_expo_ew
...
vcemway tobit log_CLI_amount_quarterly op_expo_ew rg_expo_ew ph_expo_ew, ll(0) ul(.) cluster(year isin)
...
vcemway tobit log_CLI_amount_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual, ll(0) ul(.) cluster(year isin)
...
vcemway tobit log_CLI_amount_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year, ll(0) ul(.) cluster(year isin)
...
vcemway tobit log_CLI_amount_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year i.industry_n, ll(0) ul(.) cluster(year isin)
...
vcemway tobit log_CLI_amount_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year i.industry_n i.industry_year_n, ll(0) ul(.) cluster(year isin)
...
*vcemway tobit log_CLI_amount_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year i.isin_n, ll(0) ul(.) cluster(year isin)
...
*mi impute mvn ebit at ebit_at = CLI_annual op_expo_ew rg_expo_ew ph_expo_ew us_dummy total_lobby_annual, add(100) prior(ridge, df(0.5))
mi impute mvn ebit_z at_z = CLI_quarterly CLI_amount_quarterly op_expo_ew rg_expo_ew ph_expo_ew us_dummy total_lobby_annual, add(100)

set more off
mi estimate, post: logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew, vce(cluster isin_n)
est store m1
mi estimate, post: logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual, vce(cluster isin_n)
est store m2
mi estimate, post: logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year, vce(cluster isin_n)
est store m3
mi estimate, post: logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year i.industry_n, vce(cluster isin_n)
est store m4
mi estimate, post: logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year i.industry_n i.industry_year_n, vce(cluster isin_n)
est store m5
...
logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew, vce(cluster isin_n)
est store m1_2
logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual, vce(cluster isin_n)
est store m2_2
logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year, vce(cluster isin_n)
est store m3_2
logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year i.industry_n, vce(cluster isin_n)
est store m4_2
logit CLI_quarterly op_expo_ew rg_expo_ew ph_expo_ew ebit ebit_at us_dummy total_lobby_annual i.year i.industry_n i.industry_year_n, vce(cluster isin_n)
est store m5_2
